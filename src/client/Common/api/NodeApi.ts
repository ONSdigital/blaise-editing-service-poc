...
import { AllocationDetails, Survey } from '../../../common/interfaces/surveyInterface';
...
export async function getAllocationDetails(questionnaireName: string): Promise<AllocationDetails> {
  return getDataFromNode(`/api/questionnaires/${questionnaireName}/allocation`, 'The questionnaire is no longer available');
}
