...
import ReallocateCases from '../../Supervisor/Pages/Reallocate';
  ...
  return (
    <>
      <CreateRoutes onConditionThat={userRole === UserRole.SVT_Supervisor}>
        ...
        <Route path="/questionnaires/:questionnaireName/reallocate" element={<ReallocateCases supervisorRole={UserRole.SVT_Supervisor} editorRole={UserRole.SVT_Editor} />} />
      </CreateRoutes>
