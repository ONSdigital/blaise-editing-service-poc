...
import { getCasesNotAllocatedInformation } from '../../api/NodeApi';
...
export default function AllocateCases({ supervisorRole, editorRole } : AllocateProps): ReactElement {
  ...
  const allocationInformation = useAsyncRequestWithThreeParams<CasesNotAllocatedInformation, string, UserRole, UserRole>(getCasesNotAllocatedInformation, questionnaireName, supervisorRole, editorRole);
