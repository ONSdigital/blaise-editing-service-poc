import { Questionnaire2 } from "../../common/interfaces/surveyInterface";

const questionnaireListMockObject: Questionnaire2[] = [
  {
    name: 'LMS2101_AA1',
...
export default questionnaireListMockObject;
