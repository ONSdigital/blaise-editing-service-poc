...
describe('Map case response to factsheet', () => {
  ...
  it.each(['one','dyhzjsgfkb'])('It should error when qHousehold.QHHold.PerCount can not be converted into a number', (value) => {
    // arrange
    const CaseResponseMockObject:CaseResponse = {
      "caseId": "1",
      "caseData": {
          ...
          "dmName[1]": "Richmond Ricecake",
          "dmDteOfBth[1]": "1980-01-15",
          "qHousehold.QHHold.PerCount": `${value}`,
      }
    };
    ...
    it.each(['0','',' '])('It should error when qHousehold.QHHold.PerCount is missing or zero', (value) => {
      // arrange
      const CaseResponseMockObject:CaseResponse = {
        "caseId": "1",
        "caseData": {
